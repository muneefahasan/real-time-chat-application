    ...
    <div className="h-full overflow-hidden relative backdrop-blur-lg">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        <p className="flex-1 text-lg text-white flex items-center gap-2">
         ...
         {onlineUsers.includes(selectedUsers._id)  &&<span className="w-2 h-2 rounded-full bg-green-500"></span>}
        </p>
      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
        {messages.map((msg, index) => (
          <div
            ...
            ${
              msg.senderId !== authUser._id'680f50e4f10f3cd28382ecf9'
                ? 'flex-row-reverse'
                : 'justify-end'
            }`}
          >
            ...
            <div className="text-center text-xs">
              <img
                src={
                  msg.senderId === authUser._id ?authUser?.profilePic || '680f50e4f10f3cd28382ecf9'
                    ? assets.avatar_icon
